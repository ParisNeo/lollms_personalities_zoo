...
class SD:
    def __init__(self, lollms_path:LollmsPaths, personality_config: TypedConfig, wm = "Artbot"):
        ...
        outputs_dir = lollms_path.personal_outputs_path

        # Store the path to the script
        shared_folder   = root_dir / "shared"
        self.sd_folder  = shared_folder / "sd"
        self.output_dir = outputs_dir / "sd"
    ...
    def generate(self, prompt, num_images=1, seed = -1, output_dir=None):
        self.opt.seed=seed
        ...
        files =[f for f in (output_dir/"samples").iterdir()]
