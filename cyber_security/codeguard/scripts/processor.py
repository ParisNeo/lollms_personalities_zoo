...
class Processor(APScript):
    ...
    def start_detection(self, prompt="", full_context=""):
        if self.personality_config.code_folder_path=="" or self.personality_config.tests_folder_path=="" or self.personality_config.docs_folder_path=="":
            self.full("Please setup a code folder path, a tests folder path and a docs folder path before trying to use this functionality")
