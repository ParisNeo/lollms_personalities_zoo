...
Try to write detailed description of the icon as well as stylistic elements like rounded corners or glossy and also you can mension a particular style or artist.
!@>personality name: {name}
