...
class Processor(APScript):
    ...
    def categorize_news(self):
        ...
        output += '                const textarea = document.createElement("textarea");\n'
        ...
        output += '                    alert("Summary copied to clipboard!");\n'
        output += '                } catch (err) {\n'
        output += '                    alert("Failed to copy summary. Please manually select and copy the text.");\n'
        output += '                } finally {\n'
        output += '                    document.body.removeChild(textarea);\n'
        output += '                }\n'
        output += '            };\n'
        output += '            if (navigator.clipboard) {\n'
        output += '                navigator.clipboard.writeText(text).then(() => {\n'
        output += '                    alert("Summary copied to clipboard!");\n'
        output += '                }).catch(() => {\n'
        output += '                    fallbackCopy();\n'
        output += '                });\n'
